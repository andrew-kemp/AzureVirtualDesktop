...
foreach ($vm in $vms) {
    ...
    # az CLI is available in Cloud Shell
...
#  STORAGE APP CONSENT #
# ---------------------#
# PROMPT for Storage App Display Name and Storage Account FQDN here
...
# Conditional Access policies that target All cloud apps to exclude the Storage App
